package com.edu.gdmec.s07150825.viewflipperdemo;
...
public class MainActivity extends AppCompatActivity implements GestureDetector.OnGestureListener {
    ...
    private int[] images = {R.drawable.icon1, R.drawable.icon2, R.drawable.icon3, R.drawable
            .icon4, R.drawable.icon5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i=0;i<images.length;i++){
            ...
            viewFlipper.addView(v,i,new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
